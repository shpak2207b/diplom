...
<template>
  <Teleport to="body">
    <!-- Backdrop -->
    <div v-if="cart.isOpen" class="cart-drawer-overlay" @click="close" />

    <!-- Drawer panel -->
    <div v-if="cart.isOpen" class="cart-drawer">
      ...
      <div class="cart-drawer-footer">
        ...
        <button class="btn-secondary" style="margin-top:10px;width:100%" @click="cart.clear()">
          Очистить
        </button>
      </div>
    </div>
